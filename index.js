...
//in python library it is _formats array
	formats = {
		5: {ext: 'flv', width: 400, height: 240, hasVideo: true, hasAudio: true},
		6: {ext: 'flv', width: 450, height: 20, hasVideo: true, hasAudio: true},
		//13: {ext: '3gp'},
		17: {ext: '3gp', width: 176, height: 144, hasVideo: true, hasAudio: true},
		18: {ext: 'mp4', width: 640, height: 360, hasVideo: true, hasAudio: true},
		22: {ext: 'mp4', width: 1280, height: 720, hasVideo: true, hasAudio: true},
		34: {ext: 'flv', width: 640, height: 360, hasVideo: true, hasAudio: true},
		35: {ext: 'flv', width: 854, height: 480, hasVideo: true, hasAudio: true},
		36: {ext: '3gp', width: 320, height: 240, hasVideo: true, hasAudio: true},
		37: {ext: 'mp4', width: 1920, height: 1080, hasVideo: true, hasAudio: true},
		38: {ext: 'mp4', width: 4096, height: 3072, hasVideo: true, hasAudio: true},
		43: {ext: 'webm', width: 640, height: 360, hasVideo: true, hasAudio: true},
		44: {ext: 'webm', width: 854, height: 480, hasVideo: true, hasAudio: true},
		45: {ext: 'webm', width: 1280, height: 720, hasVideo: true, hasAudio: true},
		46: {ext: 'webm', width: 1920, height: 1080, hasVideo: true, hasAudio: true},
		59: {ext: 'mp4', width: 854, height: 480, hasVideo: true, hasAudio: true},
		78: {ext: 'mp4', width: 854, height: 480, hasVideo: true, hasAudio: true},


		//3d videos
		82: {ext: 'mp4', height: 360, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},
		83: {ext: 'mp4', height: 480, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},
		84: {ext: 'mp4', height: 720, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},
		85: {ext: 'mp4', height: 1080, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},
		100: {ext: 'webm', height: 360, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},
		101: {ext: 'webm', height: 480, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},
		102: {ext: 'webm', height: 720, formatNote: '3D', preference: -20, hasVideo: true, hasAudio: true},

		// Apple HTTP Live Streaming
		92: {ext: 'mp4', height: 240, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},
		93: {ext: 'mp4', height: 360, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},
		94: {ext: 'mp4', height: 480, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},
		95: {ext: 'mp4', height: 720, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},
		96: {ext: 'mp4', height: 1080, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},
		132: {ext: 'mp4', height: 240, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},
		151: {ext: 'mp4', height: 72, formatNote: 'HLS', preference: -10, hasVideo: true, hasAudio: true},

		////DASH mp4 video
		'133': {'ext': 'mp4', 'height': 240, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'134': {'ext': 'mp4', 'height': 360, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'135': {'ext': 'mp4', 'height': 480, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'136': {'ext': 'mp4', 'height': 720, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'137': {'ext': 'mp4', 'height': 1080, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'138': {'ext': 'mp4', 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40}, // # Height can vary (https://github.com/rg3/youtube-dl/issues/4559)
		'160': {'ext': 'mp4', 'height': 144, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'264': {'ext': 'mp4', 'height': 1440, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'298': {'ext': 'mp4', 'height': 720, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'fps': 60, 'vcodec': 'h264'},
		'299': {'ext': 'mp4', 'height': 1080, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'fps': 60, 'vcodec': 'h264'},
		'266': {'ext': 'mp4', 'height': 2160, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'vcodec': 'h264'},

		//Dash mp4 audio
		'139': {'ext': 'm4a', 'format_note': 'DASH audio', 'acodec': 'aac', hasVideo: false, hasAudio: true, 'abr': 48, 'preference': -50, 'container': 'm4a_dash'},
		'140': {'ext': 'm4a', 'format_note': 'DASH audio', 'acodec': 'aac', hasVideo: false, hasAudio: true, 'abr': 128, 'preference': -50, 'container': 'm4a_dash'},
		'141': {'ext': 'm4a', 'format_note': 'DASH audio', 'acodec': 'aac', hasVideo: false, hasAudio: true, 'abr': 256, 'preference': -50, 'container': 'm4a_dash'},

		//Dash webm
		'167': {'ext': 'webm', 'height': 360, 'width': 640, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'container': 'webm', 'vcodec': 'VP8', 'preference': -40},
		'168': {'ext': 'webm', 'height': 480, 'width': 854, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'container': 'webm', 'vcodec': 'VP8', 'preference': -40},
		'169': {'ext': 'webm', 'height': 720, 'width': 1280, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'container': 'webm', 'vcodec': 'VP8', 'preference': -40},
		'170': {'ext': 'webm', 'height': 1080, 'width': 1920, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'container': 'webm', 'vcodec': 'VP8', 'preference': -40},
		'218': {'ext': 'webm', 'height': 480, 'width': 854, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'container': 'webm', 'vcodec': 'VP8', 'preference': -40},
		'219': {'ext': 'webm', 'height': 480, 'width': 854, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'container': 'webm', 'vcodec': 'VP8', 'preference': -40},
		'278': {'ext': 'webm', 'height': 144, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'container': 'webm', 'vcodec': 'VP9'},
		'242': {'ext': 'webm', 'height': 240, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'243': {'ext': 'webm', 'height': 360, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'244': {'ext': 'webm', 'height': 480, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'245': {'ext': 'webm', 'height': 480, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'246': {'ext': 'webm', 'height': 480, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'247': {'ext': 'webm', 'height': 720, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'248': {'ext': 'webm', 'height': 1080, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'271': {'ext': 'webm', 'height': 1440, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'272': {'ext': 'webm', 'height': 2160, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40},
		'302': {'ext': 'webm', 'height': 720, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'fps': 60, 'vcodec': 'VP9'},
		'303': {'ext': 'webm', 'height': 1080, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'fps': 60, 'vcodec': 'VP9'},
		'308': {'ext': 'webm', 'height': 1440, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'fps': 60, 'vcodec': 'VP9'},
		'313': {'ext': 'webm', 'height': 2160, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'vcodec': 'VP9'},
		'315': {'ext': 'webm', 'height': 2160, 'format_note': 'DASH video', hasVideo: true, hasAudio: false, 'preference': -40, 'fps': 60, 'vcodec': 'VP9'},

		//Dash webm audio
		'171': {'ext': 'webm', hasVideo: false, hasAudio: true, 'format_note': 'DASH audio', 'abr': 128, 'preference': -50},
		'172': {'ext': 'webm', hasVideo: false, hasAudio: true, 'format_note': 'DASH audio', 'abr': 256, 'preference': -50},

		//Dash webm audio with opus inside
		'249': {'ext': 'webm', hasVideo: false, hasAudio: true, 'format_note': 'DASH audio', 'acodec': 'opus', 'abr': 50, 'preference': -50},
		'250': {'ext': 'webm', hasVideo: false, hasAudio: true, 'format_note': 'DASH audio', 'acodec': 'opus', 'abr': 70, 'preference': -50},
		'251': {'ext': 'webm', hasVideo: false, hasAudio: true, 'format_note': 'DASH audio', 'acodec': 'opus', 'abr': 160, 'preference': -50},
